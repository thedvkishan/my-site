...
export const settingsSchema = z.object({
  ...
  provisionFee: z.coerce.number().min(0, 'Fee must be 0 or more.'),
  ...
  minWithdrawalAmount: z.coerce.number().positive('Minimum withdrawal amount must be a positive number.'),
